            ...
            <form className="flex column" onSubmit={this.onReplySend}>
                <div className='reply-container flex column'>
                    <div className='flex flex-end'>
                        <i className="far fa-times-circle pointer close-button-reply" onClick={this.props.onReply}></i>
                    </div>
                    <div className='to-reply-container'>To:
                    <input className="to-reply" type='text' name='to' defaultValue={this.props.eMail.fromEmail}
